...
- `News_Generated_In_Spanish.csv`: The news articles, in their original Spanish version, that were generated by the models in the experiments reported in the paper.
- `News_Generated_In_English.csv`: English translation of the articles generated by the models in the reported experiments (used in the quantitative evaluation).
